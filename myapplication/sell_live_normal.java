...
public class sell_live_normal extends AppCompatActivity {
    ...
    private View.OnClickListener _switchCameraOnClickedEvent = new View.OnClickListener() {
        ...
        public void onClick(View arg0) {
            //华为i7前后共用摄像头
            if (Camera.getNumberOfCameras() == 1) {
                Toast.makeText(sell_live_normal.this, "沒有前鏡頭喔！", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sell_live_normal);
...
//        getdata();
    ...
    private View.OnClickListener checklistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ref = FirebaseDatabase.getInstance().getReference("chat_normal").child(fuser.getUid());
    ...
    private View.OnClickListener moneylistener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            item = LayoutInflater.from(sell_live_normal.this).inflate(R.layout.dialog_normal, null);
            new AlertDialog.Builder(sell_live_normal.this)
                    .setTitle("輸入商品名稱")
                    .setView(item)
                    .setPositiveButton("確定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            EditText editText1 = (EditText) item.findViewById(R.id.money);
                            String name = editText.getText().toString();
                            String price = editText1.getText().toString();
                            getSupportActionBar().setTitle(name + "/NT$" + price);
                            order order = new order("姓名", "數量", "小計");
                            gData.add(name + "/NT$" + price);
                            ref = FirebaseDatabase.getInstance().getReference("order_nlive").child(fuser.getUid());
                            ref.child(name + ":" + price).child("0").setValue(order);
                            gdata(name + ":" + price);
                        }
                    })
                    .show();
    ...
    public void gdata(String title) {
        ref = FirebaseDatabase.getInstance().getReference("order_nlive").child(fuser.getUid())
                .child(title);
    ...
    public void sell() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(sell_live_normal.this)
