...
public class sell_yours_datachange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(sell_yours_datachange.this, buy.class);
        ...
        sbmbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(sell_yours_datachange.this);
                ...
                builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ref.child("seller_nickname").setValue(nname);
                        Toast toast=Toast.makeText(sell_yours_datachange.this,"更改成功",Toast.LENGTH_LONG);
                        toast.show();
